...
const faqs = [
  ...
  { q: "Какие способы оплаты доступны?", a: "Банковские карты Visa/MasterCard/МИР, СБП, ЮMoney, криптовалюта и баланс DIGIVAULT." },
  ...
  { q: "Есть ли поддержка 24/7?", a: "Да, среднее время ответа поддержки — менее 3 минут. Пишите в чат на сайте или Telegram @digivault." },
];

export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — частые вопросы — DIGIVAULT" },
